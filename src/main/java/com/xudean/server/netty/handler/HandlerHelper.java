...
import com.xudean.server.netty.apibiz.BaseLoggerHandler;
import com.xudean.server.util.JSONUtil;
import io.netty.buffer.ByteBuf;
import io.netty.buffer.Unpooled;
import io.netty.handler.codec.http.*;
import com.xudean.server.netty.apibiz.ApiBizErrorHandlerFactory;
...
public class HandlerHelper {
     ...
     * @param logger
     * @param request
     * @deprecated use {@link BaseLoggerHandler} instead
     */
    @Deprecated
